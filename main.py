...
def GetSimilatiry(user1, user2):
    cats_user1 = GetUserTopCategories(GetUserTweets(user1)) 
    cats_user2 = GetUserTopCategories(GetUserTweets(user2))
    CheckSimilarCatergories(cats_user1, cats_user2)
